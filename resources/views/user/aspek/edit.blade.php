...
<!-- Begin Page Content -->
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Edit Fokus Latihan Anda</h1>
        </div>
                ...
                <div class="col-md-4 border-right border-left border-top border-bottom">
                    ...
                    <div class="col-md-12">
                        ...
                        <select class="form-select" aria-label="Default select example" name="fokus" required>
                            <option selected aria-required="true" value="{{ $aspek->fokus }}">{{ $aspek->fokus }}</option>
                    ...
                    <div class="col-md-12 mt-2">
                        ...
                        <select class="form-select" aria-label="Default select example" name="motivasi" required>
                            <option selected aria-required="true" value="{{ $aspek->motivasi }}">{{ $aspek->motivasi }}</option>
                    ...
                    <div class="p-3 py-5">                        
                        <div class="col-md-12 mt-2">
                            ...
                            <select class="form-select" aria-label="Default select example" name="tingkat" required>
                                <option selected aria-required="true" value="{{ $aspek->tingkat }}">{{ $aspek->tingkat }}</option>
                        ...
                        <div class="col-md-12 mt-2">
                            ...
                            <select class="form-select" aria-label="Default select example" name="aktivitas" required>
                                <option selected aria-required="true" value="{{ $aspek->aktivitas }}">{{ $aspek->aktivitas }}</option>
                        ...
                        <div class="col-md-12 mt-2">
                            ...
                            <input type="number" name="bb" id="bb" class="form-control" placeholder="...." value="{{ $aspek->bb }}" required>
                        </div>
                        <div class="col-md-12 mt-2">
                            <label class="labels">Tinggi Badan (Cm)</label>
                            <input type="number" name="tb" id="tb" class="form-control" placeholder="..." value="{{ $aspek->tb }}" required>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 border-right border-left border-top border-bottom">
                    <div class="p-3 py-5">
                        <div class="col-md-12 mt-2">
                            ...
                            <select class="form-select" aria-label="Default select example" name="runtutan" required>
                                <option selected aria-required="true" value="{{ $aspek->runtutan }}">{{ $aspek->runtutan }}</option>
