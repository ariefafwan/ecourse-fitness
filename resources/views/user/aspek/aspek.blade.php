...
<!-- Begin Page Content -->
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Fokus Latihan Anda</h1>
        </div>
                ...
                <div class="col-md-4 border-right border-left border-top border-bottom">
                    <div class="p-3 py-5">                        
                        <div class="col-md-12 mt-2">
                            ...
                            <input type="text" name="tb" id="tb" class="form-control" value="{{ $as->tingkat }}" readonly>
                        </div>
                        <div class="col-md-12 mt-2">
                            <label for="">Bagaimana Tingkat Aktivitas Anda Sehari-Hari ?</label>
                            <input type="text" name="tb" id="tb" class="form-control" value="{{ $as->aktivitas }}" readonly>
                        </div>
                        <div class="col-md-12 mt-2">
                            <label class="labels">Berat Badan (Kg)</label>
                            <input type="text" name="tb" id="tb" class="form-control" value="{{ $as->bb }}" readonly>
                        </div>
                        <div class="col-md-12 mt-2">
                            <label class="labels">Tinggi Badan (Cm)</label>
                            <input type="text" name="tb" id="tb" class="form-control" value="{{ $as->tb }}" readonly>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 border-right border-left border-top border-bottom">
                    <div class="p-3 py-5">
                        <div class="col-md-12 mt-2">
                            ...
                            <input type="text" name="tb" id="tb" class="form-control" value="{{ $as->runtutan }}" readonly>
                        </div>
