        ...
        <div class="container rounded bg-white mt-3 mb-1">
            ...
            <div class="row">
                <div class="col-md-4 border-right">
                    <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5" width="150px" src="/img/profil/{{ $p->profile_img }}"><span class="font-weight-bold">{{ $user->name }}</span><span class="text-black-50">{{ $user->email }}</span><span> </span></div>
                    <div class="col-md-12">
                    ...
                    <div class="p-3 py-5">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="name" id="name" class="form-control" value="{{ $p->name }}" required></div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <label class="labels">Nomor Handphone</label>
                                <input type="number" name="nmrhp" id="nmrhp" class="form-control" placeholder="enter phone number" value="{{ $p->nmrhp }}" required></div>
                        </div>
                        <div class="row mt-2">
                        ...
                        <div class="row mt-2">
                            <div class="col-md-12"><label class="labels">Alamat</label>
                                <textarea name="alamat" id="alamat" cols="20" rows="2" class="form-control" required>{{ $p->alamat }}</textarea>
                            </div>
                        </div>
                        <div class="p-3 py-5">
